...
import { addTrackInQueue, setActive, setCurrentPlaylist, setCurrentTime, setDuration, setVolume, startNext, startPrev } from "./actions";
...
export const { reducer } = PlayerModel;
