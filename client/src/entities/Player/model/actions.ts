...
export const setCurrentTime = createAction<number>(PlayerActionTypes.SET_CURRENT_TIME);
...
export const addTrackInQueue = createAction<ITrack>(PlayerActionTypes.ADD_TRACK_IN_QUEUE);
